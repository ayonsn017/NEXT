"""
script for the fixed train random test condition
...
class MyAlg:
    """
    class to present fixed training questions and pretest and posttest
    questions generated from the test distribution
    """
    ...
    def initExp(self, butler, pretest_count, training_count, posttest_count,
        ...
        :param seed: int, the starting seed increment for sampling problems
        :param alg_list: list[dict], a list containing parameters that vary
        across algorithms
        for this algorithm we need pretest distribution, training data,
        posttest distribution and guard data
        ...
        butler.algorithms.set(key=parameters.guard_gap_key,
                              value=guard_gap)
        ...
        # save the pretest, training, posttest, guard data,
        # time required to finish the survey and monetary gain
    ...
    def getQuery(self, butler, participant_uid):
        ...
        if not butler.algorithms.exists(key=participant_questions_key):
            ...
            # get the data, time required to finish the survey and
            # monetary gain
            pretest_dist = \
    ...
    def generate_all_questions(self, pretest_dist, training_data,
                               posttest_dist, guard_data, pretest_seed,
                               posttest_seed, pretest_count, training_count,
                               posttest_count, guard_gap, time_required,
        ...
        :param training_data: string, the training questions in string format
        ...
        :param time_required: str, the estimated time required to complete the
        survey, showed in introduction
        ...
        '''
        # Not showing the first instruction question because we do not require
        # consent for MTurk
        # introduction instruction 1
        participant_question = \
            [instructions.get_introduction_instruction1(monetary_gain),
            '', 0, parameters.instruction_key, 0, total_questions]
