...
from apps.MoleculeEquivalence.algs.Utils import RandomInstanceGenerator, FixedInstanceReader, parameters, ParticipantInfo, instructions
import ast
...
class FixedTrainRandomTest:
    ...
    def generate_all_questions(self, pretest_file, training_file, posttest_file, pretest_seed, posttest_seed, pretest_count, 
        ...
        mol1 = instructions.get_introduction_instruction2()
        mol2 = ''
        same = 0
        ques_type = parameters.instruction_key
        participant_questions.append([mol1, mol2, same, ques_type])
