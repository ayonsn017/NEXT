...
class MyAlg:
    ...
    def initExp(self, butler, pretest_count, training_count, posttest_count, guard_gap, alg_list):
        ...
        for this algorithm we need pretest distribution, training data, posttest distribution and guard data
    ...
    def getQuery(self, butler, participant_uid):
        ...
        ques_type], same is 1 if the two molecules are the same 0 otherwise ques_type can currently be pretest, posttest
