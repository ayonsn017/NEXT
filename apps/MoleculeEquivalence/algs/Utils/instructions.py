...
def get_introduction_instruction1(monetary_gain='You will be paid through MTurk'):
    ...
    return """<h1>UNIVERSITY OF WISCONSIN-MADISON</h1><h1>Research Participant Information and Consent Form</h1><br><b>Title of the Study:</b> Chemistry representations test<br><br><b>Principal Investigator:</b> Martina Rau (phone: 608-262-0833) (email: marau@wisc.edu)<br><br><h2>DESCRIPTION OF THE RESEARCH</h2><br>You are invited to take a study about visual learning in chemistry. You will answer questions about chemistry representations.<br>You have been asked to participate because you are taking or have taken a chemistry course.<br>The purpose of the research is to find out how you learn with visual representations.<br>This study will include student volunteers, recruited from UW Madison.The survey will be conducted online. The test is fully confidential and will not assess sensitive information.<br><h2>WHAT WILL MY PARTICIPATION INVOLVE?</h2><br>If you decide to take this test, you will be asked to answer a set of up to 126 questions. The test will take about 10 minutes. <br><h2>ARE THERE ANY RISKS TO ME?</h2><br>We don't anticipate any risks to you from participation in this study.<br><h2>ARE THERE ANY BENEFITS TO ME?</h2><br>"""  + monetary_gain + """<br> <h2>WILL I BE COMPENSATED FOR MY PARTICIPATION?</h2><br>You will be entered in a lottery to win a $50 cash prize.<br><h2>HOW WILL MY CONFIDENTIALITY BE PROTECTED?</h2><br>All data collected for this study is confidential. <br><h2>WHOM SHOULD I CONTACT IF I HAVE QUESTIONS?</h2><br>You may ask any questions about the research at any time. If you have questions about the research after you leave today you should contact the Principal Investigator Martina Rau at 608-262-0833.<br>If you are not satisfied with response of research team, have more questions, or want to talk with someone about your rights as a research participant, you should contact the Education Research and Social &amp; Behavioral Science IRB Office at 608-263-2320.<br>Your participation is completely voluntary. If you decide not to participate or to withdraw from the study it will have no effect on your grade in this class.By clicking 'Proceed' below, you indicate that you have read this consent form, had an opportunity to ask any questions about your participation in this research and voluntarily consent to participate."""
