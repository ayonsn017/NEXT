...
def test_api(assert_200=True, num_experiments=1, num_clients=8):
    ...
    initExp_args_dict['args']['targets']['n'] = num_objects             ###   CHANGE THESE
    ...
    for i in range(num_clients):
        ...
        pool_args.append( (exp_uid,participant_uid,assert_200) )
...
def simulate_one_client( input_args ):
    exp_uid,participant_uid,assert_200 = input_args
    total_pulls = 126           # total number of questions
