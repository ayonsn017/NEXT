...
class RandomTrainTest:
    ...
    def initExp(self,butler, n, d, pretest_count, training_count, posttest_count,pretest_file, training_file, posttest_file):
        ...
        log_file.write('Will this work: ' + pretest_file + '?\n')
        log_file.close()
